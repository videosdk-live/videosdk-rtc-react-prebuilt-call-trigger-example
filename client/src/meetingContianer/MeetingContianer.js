  ...
  return (
    ...
    >
      <div style={{ height: tollbarHeight }}>
        <button className={"call_button blue"} onClick={join}>
          JOIN
        </button>
        <button className={"call_button red"} onClick={leave}>
          LEAVE
        </button>
        <button className={"call_button blue"} onClick={toggleMic}>
          toggleMic
        </button>
        <button className={"call_button blue"} onClick={toggleWebcam}>
          toggleWebcam
        </button>
        <button className={"call_button blue"} onClick={toggleScreenShare}>
          toggleScreenShare
        </button>
        <button className={"call_button blue"} onClick={handlestartVideo}>
          startVideo
        </button>
        <button className={"call_button blue"} onClick={handlestopVideo}>
          stopVideo
        </button>
        <button className={"call_button blue"} onClick={handleresumeVideo}>
          resumeVideo
        </button>
        <button className={"call_button blue"} onClick={handlepauseVideo}>
          pauseVideo
        </button>
        <button className={"call_button blue"} onClick={handlesseekVideo}>
          seekVideo
        </button>

        <button className={"call_button blue"} onClick={handleStartLiveStream}>
          Start Live Stream
        </button>
        <button className={"call_button blue"} onClick={handleStopLiveStream}>
          Stop Live Stream
        </button>
        <button className={"call_button blue"} onClick={handleStartRecording}>
          start recording
        </button>
        <button className={"call_button blue"} onClick={handleStopRecording}>
          stop recording
        </button>
      </div>
...
const MeetingContianer = ({ token, meetingId, name }) => {
...
export default MeetingContianer;
